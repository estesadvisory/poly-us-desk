...
test "$(cat VERSION)" = "v20" || { echo "VERSION mismatch"; cat VERSION; exit 1; }
python3 desk.py --go
```
...
- LIVE or ticking SOON (≤45m) `aec-`, all US sports, 12–88¢ book. Max 1 per league. A league with ≥2 losses and 0 wins today is cold. SOON needs a bid uptick.
