# Desk v19 — architecture

**Live version: v19.** One Terminal: `python3 desk.py --go`. Zero LLM in the loop.
...
- All operational US leagues. LIVE or ticking SOON (≤45m) `aec-`. Overdue NS kept live 90m.
